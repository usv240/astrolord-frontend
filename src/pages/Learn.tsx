...
import { ArrowLeft, BookOpen, Star, Moon, Sun, Sparkles, Info, HelpCircle, Menu } from 'lucide-react';
          ...
          <main className="container mx-auto px-4 md:px-6 py-6 md:py-12">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-8 md:mb-12">
                <BookOpen className={`${isMobile ? 'h-12 w-12' : 'h-16 w-16'} text-accent mx-auto mb-3 md:mb-4`} />
              ...
              <Tabs defaultValue="basics" className="space-y-6 md:space-y-8">
                {/* Mobile-friendly scrollable tabs with touch-friendly sizing */}
                <TabsList className="overflow-x-auto flex w-full lg:grid lg:grid-cols-5 gap-1 p-1 no-scrollbar">
                  <TabsTrigger value="basics" className="min-w-fit px-3 md:px-4 text-sm md:text-base whitespace-nowrap">Basics</TabsTrigger>
                  <TabsTrigger value="chart" className="min-w-fit px-3 md:px-4 text-sm md:text-base whitespace-nowrap">Your Chart</TabsTrigger>
                  <TabsTrigger value="features" className="min-w-fit px-3 md:px-4 text-sm md:text-base whitespace-nowrap">Features</TabsTrigger>
                  <TabsTrigger value="tutorial" className="min-w-fit px-3 md:px-4 text-sm md:text-base whitespace-nowrap">Tutorial</TabsTrigger>
                  <TabsTrigger value="glossary" className="min-w-fit px-3 md:px-4 text-sm md:text-base whitespace-nowrap">Glossary</TabsTrigger>
                </TabsList>

                {/* Basics Tab */}
                <TabsContent value="basics" className="space-y-6">
                  <div className="p-4 sm:p-8 rounded-lg bg-card/50 backdrop-blur-sm border border-border/50">
                  ...
                  <div className="p-4 sm:p-8 rounded-lg bg-gradient-to-br from-accent/10 to-purple-500/10 backdrop-blur-sm border border-accent/30">
                ...
                <TabsContent value="chart" className="space-y-6">
                  ...
                  <div className="p-4 sm:p-8 rounded-lg bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur-sm border border-primary/30">
              ...
              {/* CTA Section */}
              <div className="mt-8 md:mt-12 p-5 md:p-8 rounded-lg bg-gradient-to-br from-accent/20 to-purple-500/20 backdrop-blur-sm border border-accent/30 text-center">
                <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">Ready to Explore Your Cosmic Blueprint?</h3>
